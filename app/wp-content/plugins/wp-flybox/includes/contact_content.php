...
function wpfb_contact_submit() {
  window.open('<?php echo plugins_url(); ?>/wp-flybox/<contactx></contactx>.php', 'popupwindow', 'scrollbars=yes,location=no,menubar=no,width=600,height=400');
...
echo ':</b></span><br><form style="padding:5px;" action="'.plugins_url().'/wp-flybox/contact.php" method="post" target="popupwindow" onsubmit="wpfb_contact_submit();return true">
  ...
  <span id="wpfb_phone"><p>'.$wpl_Phone.': <input style="padding:1px;" class="enteryourphone" name="name" id="phone" type="text" /></p></span>
