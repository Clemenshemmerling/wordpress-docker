<?php
$wpflybox_open_in = '_self';
if (get_option('wpflybox_custom_URL_new_wind')==='true'){$wpflybox_open_in = '_blank';}
if (get_option('wpflybox_custom2_URL_instead')==='true'){echo '<a href="'.stripslashes(get_option('wpflybox_custom2_content')).'" target="'.$wpflybox_open_in.'">';}
...
if ($wpflybox_side=='right')
  ...
  echo '<img id="wpfb_tab_img'.$i.'" src="'.get_option('wpflybox_my_custom2_tab').'" style="width:'.$wpflybox_custom2_tab_width.'px;height:'.$wpflybox_custom2_tab_height.'px" alt="?">';
  }
