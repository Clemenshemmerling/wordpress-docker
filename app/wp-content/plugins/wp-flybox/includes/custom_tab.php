...
if (get_option('wpflybox_custom_URL_instead')==='true'){echo '<a href="'.stripslashes(get_option('wpflybox_custom_content')).'" target="'.$wpflybox_open_in.'">';}
...
if ($wpflybox_side=='right')
  ...
  echo '<img id="wpfb_tab_img'.$i.'" src="'.get_option('wpflybox_my_custom_tab').'" style="width:'.$wpflybox_custom_tab_width.'px;height:'.$wpflybox_custom_tab_height.'px" alt="?">';
  }
